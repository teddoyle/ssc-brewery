...
@RequestMapping(BreweryConstants.BEER_API_PREFIX) // "/api/v1/")
@RestController
public class BeerRestController {
    ...
    @GetMapping(produces = { "application/json" }, path = BreweryConstants.BEER_API_SUFFIX) // "beer/")
    ...
    @GetMapping(path = {BreweryConstants.BEER_API_SUFFIX+ "{beerId}"}, produces = { "application/json" })
